...
def main():
    ...
    # get credentials.json from https://console.cloud.google.com/apis/credentials -> OAuth 2.0 Client IDs
    ...
    try:
        ...
        with open(rf'C:\Users\parth\Desktop\self_logging\{filename}', 'w') as f:
